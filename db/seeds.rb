...
science fiction and fantasy.")wg_work1 = WgWork.create!(author: "test", bio: "test", title: "test", version: "1", content: "a", writer_group_id: 1)

wg_comment1 = WgComment.create!(author: "Test commenter 1", content: "Test content 1", wg_work_id: 1)
wg_comment2 = WgComment.create!(author: "Test commenter 2", content: "Test content 2", wg_work_id: 2)
